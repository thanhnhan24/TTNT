...
if __name__ == '__main__':
    client = ModbusTcpClient(ip="192.168.1.165")


    # Đọc thanh ghi địa chỉ 17, đọc 1 thanh ghi
    code, registers = client.read_holding_registers(0x17, 1)
    if code == 0:
        print(f"Giá trị thanh ghi 17: {registers}")
    else:
        print(f"Lỗi đọc thanh ghi: {code}")
